...
frameworkReplicasList="4" # min is 4 because of PBCs
############################################################################### 
...
# loop over number of molecules per pore
for molecPerPore in 2 4 6 8 10 12 14; do

  echo "Molecules per pore: $molecPerPore"
  ...
  isothermData-74/${metal}_${guest}_${tempInt}_absolute.txt))
        ...
        if [ $metal = "Mg" ]; then
          replicasGuest=$(echo "($frameworkReplicas * 6 * $molecPerPore)/4" | bc -l)
        elif [ $metal = "Ni" ]; then
          replicasGuest=$(echo "($frameworkReplicas * 6 * $molecPerPore)/4" | bc -l)
        elif [ $metal = "Zn" ]; then
          replicasGuest=$(echo "($frameworkReplicas * 6 * $molecPerPore)/2" | bc -l)
        fi
  ...
  >> ${dataFile}
        ...
        if [ $metal = "Mg" ]; then
          for number in $(seq 1 $molecPerPore); do 
            sed -i "s/^$((1 + (number - 1)*6)) 1 1 0.000000.*/$((1 + (number - 1)*6)) $((1 + (number - 1)*6)) 1 0.000000 2.0 44.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((2 + (number - 1)*6)) 1 1 0.000000.*/$((2 + (number - 1)*6)) $((2 + (number - 1)*6)) 1 0.000000 2.0 30.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((3 + (number - 1)*6)) 1 1 0.000000.*/$((3 + (number - 1)*6)) $((3 + (number - 1)*6)) 1 0.000000 2.0 15.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((4 + (number - 1)*6)) 1 1 0.000000.*/$((4 + (number - 1)*6)) $((4 + (number - 1)*6)) 1 0.000000 13.0 37.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((5 + (number - 1)*6)) 1 1 0.000000.*/$((5 + (number - 1)*6)) $((5 + (number - 1)*6)) 1 0.000000 13.0 22.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((6 + (number - 1)*6)) 1 1 0.000000.*/$((6 + (number - 1)*6)) $((6 + (number - 1)*6)) 1 0.000000 13.0 7.0 ${number}.0 # CH4/" ${dataFile}
          done
        elif [ $metal = "Ni" ]; then
          for number in $(seq 1 $molecPerPore); do 
            sed -i "s/^$((1 + (number - 1)*6)) 1 1 0.000000.*/$((1 + (number - 1)*6)) $((1 + (number - 1)*6)) 1 0.000000 2.0 44.0 ${number}.0 # CH4/" ${dataFile}
          ...
          for number in $(seq 1 $molecPerPore); do 
            sed -i "s/^$((1 + (number - 1)*12)) 1 1 0.000000.*/$((1 + (number - 1)*12)) $((1 + (number - 1)*12)) 1 0.000000 2.0 44.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((2 + (number - 1)*12)) 1 1 0.000000.*/$((2 + (number - 1)*12)) $((2 + (number - 1)*12)) 1 0.000000 2.0 30.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((3 + (number - 1)*12)) 1 1 0.000000.*/$((3 + (number - 1)*12)) $((3 + (number - 1)*12)) 1 0.000000 2.0 15.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((4 + (number - 1)*12)) 1 1 0.000000.*/$((4 + (number - 1)*12)) $((4 + (number - 1)*12)) 1 0.000000 12.0 37.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((5 + (number - 1)*12)) 1 1 0.000000.*/$((5 + (number - 1)*12)) $((5 + (number - 1)*12)) 1 0.000000 12.0 22.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((6 + (number - 1)*12)) 1 1 0.000000.*/$((6 + (number - 1)*12)) $((6 + (number - 1)*12)) 1 0.000000 12.0 7.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((7 + (number - 1)*12)) 1 1 0.000000.*/$((7 + (number - 1)*12)) $((7 + (number - 1)*12)) 1 0.000000 25.0 44.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((8 + (number - 1)*12)) 1 1 0.000000.*/$((8 + (number - 1)*12)) $((8 + (number - 1)*12)) 1 0.000000 25.0 30.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((9 + (number - 1)*12)) 1 1 0.000000.*/$((9 + (number - 1)*12)) $((9 + (number - 1)*12)) 1 0.000000 25.0 15.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((10 + (number - 1)*12)) 1 1 0.000000.*/$((10 + (number - 1)*12)) $((10 + (number - 1)*12)) 1 0.000000 38.0 37.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((11 + (number - 1)*12)) 1 1 0.000000.*/$((11 + (number - 1)*12)) $((11 + (number - 1)*12)) 1 0.000000 38.0 22.0 ${number}.0 # CH4/" ${dataFile}
            sed -i "s/^$((12 + (number - 1)*12)) 1 1 0.000000.*/$((12 + (number - 1)*12)) $((12 + (number - 1)*12)) 1 0.000000 38.0 7.0 ${number}.0 # CH4/" ${dataFile}
          done
        fi
        # prepare .in file
        cp template-increasing-Ds.in ${inFile}
  ...
  mkdir MOF-74-CH4-input-files-increasing-Ds/
  mkdir MOF-74-CH4-input-files-increasing-Ds/molec-per-pore-${molecPerPore}/
  mv *Pressure* MOF-74-CH4-input-files-increasing-Ds/molec-per-pore-${molecPerPore}/.
