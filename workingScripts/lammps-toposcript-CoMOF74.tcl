...
# my variables
set structure Co-MOF-74.pdb
set guest GUESTFILE
set atomsPerMOF 324
set atomsPerGuest ATOMSPERGUEST
set latticeVectorA 26.1988
set latticeVectorB 45.3777
set latticeVectorC 6.88911
set alpha 90.0
set beta 90.0
set gamma 90.0
set replicasMOFX 1
...
set sel [atomselect top {name Co1}]
$sel set radius 1.26
$sel set name Co1
$sel set type Co1
$sel set mass 58.933
$sel set charge 1.189
