...
set latticeVectorB 45.9374
set latticeVectorC 7.15074
set alpha 90.0
set beta 90.0
set gamma 90.0
set replicasMOFX 1
...
set sel [atomselect top {name Mn1}]
$sel set radius 1.39
$sel set name Mn1
$sel set type Mn1
$sel set mass 54.938 
$sel set charge 1.343
