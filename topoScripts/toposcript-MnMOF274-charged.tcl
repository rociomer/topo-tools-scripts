...
# my variables
set structure frameworkStructures/Mn-MOF-274.pdb
set guest adsorbateStructures/GUESTFILE
set atomsPerMOF 84
set atomsPerGuest ATOMSPERGUEST
set latticeVectorA 22.024
set latticeVectorB 22.012 
set latticeVectorC 7.127 
set alpha 90.04
set beta 89.99
set gamma 120.01
set replicasMOFX 2
...
set sel [atomselect top {name Mn}]
$sel set radius 1.39
$sel set name Mn
$sel set type Mn
$sel set mass 54.938 
$sel set charge 1.38137
